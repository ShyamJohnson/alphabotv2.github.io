...
<span class="line"><span>}</span></span></code></pre></div><h2 id="output" tabindex="-1">Output <a class="header-anchor" href="#output" aria-label="Permalink to &quot;Output&quot;">​</a></h2><h2 id="exercise-🤖" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to print rectangle ,Triangle and circle in the OLED Display.</li><li>Try to Print a Simple Stickman in the OLED Display</li></ul> # Simple Activities <h2 id="printing-the-your-name-and-some-random-text" tabindex="-1">Printing The Your Name and Some Random text <a class="header-anchor" href="#printing-the-your-name-and-some-random-text" aria-label="Permalink to &quot;Printing The Your Name and Some Random text&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  #include &lt;Wire.h&gt;</span></span>
<span class="line"><span>  #include &lt;Adafruit_GFX.h&gt;</span></span>
<span class="line"><span>  #include &lt;Adafruit_SSD1306.h&gt;</span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>  // OLED display setup</span></span>
...
<span class="line"><span>  Rand();</span></span>
<span class="line"><span>  delay(5000);</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>Tilt/press the joystick, and the corresponding direction will print: </li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to print rectangle ,Triangle and circle in the OLED Display.</li><li>Try to Print a Simple Stickman in the OLED Display</li></ul>`,15)]))}const h=a(e,[["render",i]]);export{y as __pageData,h as default};
