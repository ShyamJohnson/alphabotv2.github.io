...
<span class="line"><span>  </span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>Two pairs of LEDs light up in an alternating fashion (1+2 → 0+3). </li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to make Different patterns in RGB LEDs (say turning on one after another and turning off similarly.</li></ul>`,15)]))}const B=s(l,[["render",i]]);export{u as __pageData,B as default};
