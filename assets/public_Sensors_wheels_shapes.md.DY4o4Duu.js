...
<span class="line"><span>  digitalWrite(BIN1, LOW);</span></span>
<span class="line"><span>  digitalWrite(BIN2, LOW);</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output" tabindex="-1">Output <a class="header-anchor" href="#output" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>The robot will move in a square pattern: forward for 1 second, turn right (pivot) for 0.4 seconds, and repeat 4 times before stopping completely.</li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to make the robot move in a circular motion. </li></ul>`,15)]))}const W=s(i,[["render",l]]);export{u as __pageData,W as default};
