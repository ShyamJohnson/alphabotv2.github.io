...
<span class="line"><span>}</span></span></code></pre></div><h2 id="exercise-🤖" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to make the robot move in a square motion. </li><li>Try to make the robot move in a circular motion. </li></ul><ul><li>To develop a motion control algorithm that allows the robot to execute dynamic manoeuvres such as forward movement, turning left or right, and stopping.</li></ul>`,8)]))}const W=a(l,[["render",i]]);export{h as __pageData,W as default};
