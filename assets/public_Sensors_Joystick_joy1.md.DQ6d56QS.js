...
<span class="line"><span>  }</span></span>
<span class="line"><span>  return data;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>Tilt/press the joystick, and the corresponding direction will print: </li><ul><li>UP (if pushed forward)</li><li>DOWN (if pulled backward)</li><li>LEFT (if pushed left)</li><li>RIGHT (if pushed right)</li><li>CENTER (if pressed down)</li></ul></ul>`,12)]))}const b=n(i,[["render",l]]);export{h as __pageData,b as default};
