import{_ as s,c as a,o as p,ae as e}from"./chunks/framework.Dq8kYo8j.js";const h=JSON.parse('{"title":"Simple Activities - Decode IR Signal","description":"","frontmatter":{},"headers":[],"relativePath":"public/Sensors/IR/ir1.md","filePath":"public/Sensors/IR/ir1.md"}'),l={name:"public/Sensors/IR/ir1.md"};function i(t,n,c,o,r,d){return p(),a("div",null,n[0]||(n[0]=[e(`<h1 id="simple-activities-decode-ir-signal" tabindex="-1">Simple Activities - Decode IR Signal <a class="header-anchor" href="#simple-activities-decode-ir-signal" aria-label="Permalink to &quot;Simple Activities - Decode IR Signal&quot;">​</a></h1><h2 id="problem-statement" tabindex="-1">Problem Statement <a class="header-anchor" href="#problem-statement" aria-label="Permalink to &quot;Problem Statement&quot;">​</a></h2><ul><li>Write a code to Alphabot so that when a button on IR remote is pressed the respective command should be Displayed in the Serial Monitor</li></ul><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-label="Permalink to &quot;Code&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  #define IR     4</span><span>           // IR remote receiver pin </span></span>
...
<span class="line"><span>      </span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>This code enables wireless control of the AlphaBot V2 using an infrared (IR) remote. The robot responds to button presses by printing commands to the Serial Monitor (at 115200 baud). Here&#39;s what happens when you run it. </li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to code Yourself and Print the Value When the button is pressed</li></ul>`,15)]))}const m=s(l,[["render",i]]);export{h as __pageData,m as default};
