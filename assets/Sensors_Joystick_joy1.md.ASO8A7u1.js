...
<span class="line"><span>}</span></span></code></pre></div><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-label="Permalink to &quot;&quot;">​</a></h2><ul><li>Tilt/press the joystick, and the corresponding direction will print: </li><ul><li>UP (if pushed forward)</li><li>DOWN (if pulled backward)</li><li>LEFT (if pushed left)</li><li>RIGHT (if pushed right)</li><li>CENTER (if pressed down)</li></ul></ul>`,8)]))}const b=a(i,[["render",l]]);export{h as __pageData,b as default};
