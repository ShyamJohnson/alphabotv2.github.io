...
<span class="line"><span>  delay(1000);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="exercise-🤖" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to make a Simple Melody Using Buzzer in the Alphabot</li></ul>`,7)]))}const b=a(i,[["render",l]]);export{h as __pageData,b as default};
