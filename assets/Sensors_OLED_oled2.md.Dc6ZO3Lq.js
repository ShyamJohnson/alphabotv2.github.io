...
<span class="line"><span>  Rand();</span></span>
<span class="line"><span>  delay(5000);</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>A small Circle is displayed in OLED Display.</li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to Print a Rectangle ,Triangle and a Simple Stickman in the OLED Display</li></ul>`,9))])}const b=p(d,[["render",u]]);export{D as __pageData,b as default};
