...
<span class="line"><span>  Serial.println();</span></span>
<span class="line"><span>  Serial.println();</span></span>
<span class="line"><span>  Serial.println();}</span></span></code></pre></div><h2 id="output-1" tabindex="-1">Output <a class="header-anchor" href="#output-1" aria-label="Permalink to &quot;Output&quot;">​</a></h2><ul><li>This code reads values from 5 infrared (IR) line sensors and prints their readings to the Serial Monitor. </li></ul><h2 id="exercise-🤖-1" tabindex="-1">Exercise 🤖 <a class="header-anchor" href="#exercise-🤖-1" aria-label="Permalink to &quot;Exercise 🤖&quot;">​</a></h2><ul><li>Try to code Yourself and Print the Value and Check the Readings when Alphabot is in different position in White line Track</li></ul>`,16)]))}const f=s(i,[["render",l]]);export{h as __pageData,f as default};
