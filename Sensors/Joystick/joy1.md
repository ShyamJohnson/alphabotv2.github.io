...
# Simple Activities - Joystick direction

## Problem Statement
<h4>Write a code for Alphabot ,So that when the Joystick is pressed, the direction has to be print in the Serial Monitor : </h4>
<ul>
