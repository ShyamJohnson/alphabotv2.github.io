...
<ul>
<li>Write a code to Alphabot which has to make the robot move in a square pattern: forward for 1 second, turn right (pivot) for 0.4 seconds, and repeat 4 times before stopping completely.</li>
</ul>
