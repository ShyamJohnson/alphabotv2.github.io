...
# Simple Activities - Sequential LED Activation

## Problem Statement
<ul>
<li>Write a code to Alphabot where LED has to Blink like a "forward march" of colors (Red → Green → Blue → White), followed by LEDs turning off in the same order.</li>
</ul>
...
<ul>
<li>Try to make Different patterns in RGB LEDs (say turning on one after another and turning off similarly.)</li></UL>
