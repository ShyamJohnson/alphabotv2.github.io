...
# Simple Activities - Beep Sound

## Problem Statement
<ul>
<li>Write a code to Alphabot where The buzzer has to produce an audible beep for 1 second, then stay silent for 1 second, repeating indefinitely.</li>
</ul>
