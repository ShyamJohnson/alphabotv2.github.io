...
# Simple Activities - Print Sensor Values

## Problem Statement
<ul>
<li>Write a code to Alphabot so that it reads values from 5 infrared (IR) line sensors and prints their readings to the Serial Monitor.</li>
</ul>
